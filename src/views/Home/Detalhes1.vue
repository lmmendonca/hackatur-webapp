  ...
  <v-container fluid grid-list-md>
    <v-layout row wrap>
      ...
      <v-card>
        ...
        <v-card-title class="headline">Final de Feriado Fora do Óbivio</v-card-title>

        <v-card-text class="subtitle">
          <b>Valor:</b> R$ 20,00 + Alimentação &nbsp;&nbsp;&nbsp;&nbsp;
